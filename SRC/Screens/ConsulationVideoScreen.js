...
const ConsulationVideoScreen = () => {
  ...
  // console.log("🚀 ~ ConsulationVideoScreen ~ user:", user)
  const [item, setItem] = useState('');
  const [Loading, setLoading] = useState(false);
  const [barberVideo, setBarberVideo] = useState([]);
  // console.log('🚀 ~ ConsulationVideoScreen ~ barberVideo:', barberVideo);
  ...
  const barberConsultancyVideo = async () => {
    ...
    if (response != undefined) {
      // console.log("🚀 ~ barberConsultancyVideo ~ response:", response?.data)
  ...
  const answerList = async () => {
    ...
    setLoading(false);
    if (response != undefined) {
      // console.log('🚀 ~ answerList ~ response:', response?.data?.video_info);
        ...
        {Loading ? (
          ...
          <FlatList
            ...
            renderItem={({item, index}) => {
              // console.log("🚀 ~ ConsulationVideoScreen ~ item======>:", item)
